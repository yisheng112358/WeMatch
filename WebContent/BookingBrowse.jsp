...
<body>
	...
	<form action="TestbookingWeb" method="post" id="form1" name="form1">
	   ...
	   <div id="checkboxGroup" name="checkboxGroup">
		...
		<span><label> <input style="display:none" type="checkbox" name="Dumbbells1" value="Dumbbells1"><img id="image1" value="true" src="images/star.gif" onclick="myfunction()"></label></span>
		<span><label> <input style="display:none" type="checkbox" name="Dumbbells2" value="Dumbbells2"><img id="image2" src="images/star.gif" onclick="myfunction2()"></label></span>
		<span><label> <input style="display:none" type="checkbox" name="Dumbbells3" value="Dumbbells3"><img id="image3" src="images/star.gif" onclick="myfunction3()"></label></span>
		<span><label> <input style="display:none" type="checkbox" name="Dumbbells4" value="Dumbbells4"><img id="image4" src="images/star.gif" onclick="myfunction4()"></label></span>
