...
<div style="text-align:center;background-color:lightblue;">
	<form action="<c:url value="bookingcontroller/booking"/>" method="post" id="form1" name="form1" >
	
	    <input type="date" name="date" required value="2020-09-12" min="2020-09-12"max="2020-09-20" step="1"> <br />
