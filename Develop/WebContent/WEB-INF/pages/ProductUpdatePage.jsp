				...
				<div class="comment-form-wrap pt-5">
					...
					<form action="<c:url value='/product/updateProduct' />"
						...
						<div class="form-group">
							<label for="productName">產品ID *</label> <span id="productSp"
						...
						<div class="form-group">
							<label for=productPrice>產品價格 *</label> <span id="productSp"
								class="notice"></span><br />
							<%
								out.write("<input type='text' value=" + productUpdate.getPrice()
									+ " id='productPriceId' class='form-control' name='price' required='required' placeholder='最多6位數' maxlength='6' onblur='checkProductPrice()'>");
							%>
						</div>
						<div class="form-group">
							<label for="productStock">庫存 *</label> <span id="stockSp"
								class="notice"></span><br />
							<%
								out.write("<input type='text' value=" + productUpdate.getStock()
									+ " id='productStockId' class='form-control' name='stock' required='required' onblur='checkProductStock()'>");
							%>
						</div>
						<div class="form-group">
							<label for="productDescription">產品介紹</label>
							<%
								out.write("<textarea name='productDescription' id='productDescriptionId' cols='30' rows='10' class='form-control'>"
									+ productUpdate.getProductDescription() + "</textarea>");
							%>
						</div>
						<div class="form-group">
