...
<body data-spy="scroll" data-target=".site-navbar-target"
 ...
 <section class="ftco-section ftco-services-2" id="services-section">
  ...
  <div
   ...
   <input type="button" onclick="oneGo1()" value="1"/>
   <input type="button" onclick="oneGo2()" value="2"/>
   <input type="button" onclick="oneGo3()" value="3"/>
  </div>
  <script>
   var date = new Date();
   ...
   function oneGo1(){
     document.getElementById("listNAME").value="豆漿";
     document.getElementById("caloRIES").value="150";
    }
   function oneGo2(){
    document.getElementById("listNAME").value="肉鬆";
    document.getElementById("caloRIES").value="232";
   }
   function oneGo3(){
    document.getElementById("listNAME").value="巧克力";
