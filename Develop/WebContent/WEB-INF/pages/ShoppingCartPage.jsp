...
<body data-spy="scroll" data-target=".site-navbar-target"
		...
		<div style="text-align: center;">
			...
			if (carts.size() != 0) {
				...
				for (ProductBean product : carts) {
					...
					out.write("<td><input id='quantity" + product.getProductId() + "' type='text' value='1' /></td>");
	...
	<section class="ftco-section ftco-schedule" id="schedule-section">
		...
		<div  style="text-align: center;width: 700px; margin-left: auto;
	margin-right: auto;padding: 50px;background-color:	#FFBD9D;border-radius: 30px;">
	<p style="font-color:black;font-weight:bold;font-size: larger;">[ 請填寫收件人資訊  ]</p>		
			<form:form action="addTransportInformation" method="POST"
				modelAttribute="transportInformation">
				<table style="width: 600px;margin-left:auto;padding: 100px;margin: 20px;padding: 50px;background-color:	#FFBD9D;">
					<tr>
						<td style="font-color:	#336666;font-weight:bold;"><form:label path="totalAmount" >總金額：</form:label></td>
						<td><form:input path="totalAmount" class="form-control"   id='totalAmount' /></td>
					</tr>
					<tr>
						<td style="font-color:#804040;font-weight:bold;"><form:label path="receiverName">姓名：</form:label></td>
						<td><form:input path="receiverName" class="form-control"  /></td>
					</tr>
					<tr>
						<td style="font-color:#804040;font-weight:bold;"><form:label path="receiverPhone">電話：</form:label></td>
						<td><form:input path="receiverPhone" class="form-control"   /></td>
					</tr>
					<tr>
						<td style="font-color:#804040;font-weight:bold;"><form:label path="receiverAddress">地址：</form:label></td>
						<td><form:input path="receiverAddress" class="form-control"   /></td>
					</tr>
					<tr>
						<td style="font-color:#804040;font-weight:bold;"><form:label path="receiverEmail">信箱：</form:label></td>
						<td><form:input path="receiverEmail" class="form-control"   /></td>
					</tr>
					<tr>
						<td style="font-color:#804040;font-weight:bold;"><form:label path="receiverNote">備註：</form:label></td>
