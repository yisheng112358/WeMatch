			...
			<div align="center">
				...
				<form action="<c:url value="saveCoach" />" method="POST"  enctype="multipart/form-data" >
					...
					<div class="inputDiv">
						...
						<input class="whitecolor" name="coachName" type="text" />
					</div><br />
					<div class="inputDiv">
						<label class='koTitle'>教練暱稱:</label><br /> 
						<input class="whitecolor" name="coachNickname" type="text" />
					</div><br />
					<div class="inputDiv">
						<label class='koTitle'>年齡:</label><br /> 
						<input class="whitecolor" name="coachAge" type="text" />
					</div><br />
					<div class="inputDiv">
						<label class='koTitle'>授課名稱:</label><br /> 
						<input class="whitecolor" name="courseName" type="text" />
					</div><br />
					<div class="inputDiv">
						<label class='koTitle'>授課類別:</label><br /> 
						<input class="whitecolor" name="courseType" type="text" />
					</div><br />
					<div class="inputDiv">
						<label class='koTitle'>相關證照:</label><br /> 
						<input class="whitecolor" name="license" type="text" />
					</div><br />
					<div class="retrunDiv">
