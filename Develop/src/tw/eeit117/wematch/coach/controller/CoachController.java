...
public class CoachController {
	...
	public ModelAndView saveCoach(@RequestParam(name="coachPic") MultipartFile multipartFile,
			...
			@RequestParam(name="coachAge") Integer coachAge,			
			@RequestParam(name="courseName") String courseName,
			@RequestParam(name="courseType") String courseType,
			@RequestParam(name="license") String license, HttpServletRequest request) throws IOException {
	...
	private void savePicture(String coachName, String coachNickname, Integer coachAge, 
			String courseName,String courseType,String license,String savePath) throws IOException {
		Coach coach = new Coach();
	...
	public ModelAndView editCoach(
			...
			@RequestParam(name="courseName") String courseName,
			@RequestParam(name="courseType") String courseType,
			@RequestParam(name="license") String license, HttpServletRequest request, Model model) throws Exception, IOException {
	...
	private void updatePicture(String coachName, String coachNickname, Integer coachAge, 
			String courseName,String courseType,String license,String savePath, Integer coachId) throws IOException {
